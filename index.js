...
function exerciseDog(dogName, dogBreed){
    ...
    //routine.forEach(action => action)
    //array.map(action => action)
}

//const exerciseDog = routine.map(action => action)

//const exerciseDog = routine.map(function(dogName, dogBreed));